 ...
 function checklogin($login,$password)
    {
        ...
        // $responsecode = 200;
         ...
         $returnarray = array('status' => 1, 'user_id' => $customer_id,'token' =>$token);
          ...
          {
             // $responsecode = 400;
              $returnarray = array('status' => 0, 'error' => ' fail, Username or pasword is invalid' );
          }
          return $returnarray;                
    }
  function user_registration(){
    ...
    if($data[0] > 1) {
    $returnresult = array('status' => 0, 'message' => 'User already in Exists' );
 }
else{
    ...
    // $profile_pic = rand(1000,1000000).".".$imgExt;
    // if(in_array($imgExt, $valid_extensions)){     
    //     if($imgSize < 5000000)        {
    //       $upload= move_uploaded_file($tmp_dir,$upload_dir.$profile_pic);
    //     }
    //   }
      ...
      'phone_number_voice_notification' => $_REQUEST['phone_number_voice_notification'],
       'password' => md5($_REQUEST['password']),
        ...
        $data = $this->db->insert('tbl_user', $data);
            if($data){
             $returnresult = array('status' => 1, 'message' => 'User registration successfully submit');
             }else
            {          
             $returnresult = array('status' => 0, 'error' => 'Some data not valid' );
           }
        }
//       else{
// $data = array(
...
FROM `tbl_community` tc");
 ...
 function get_community_result(){
     ...
     $returnresult = array('status' => 1, 'message' => 'User request successfully submit','request_status'=> $_REQUEST['request_status']);
   }
 }
else{
      $data = array(
      ...
      // if($data){
         $sql ="SELECT * FROM tbl_community_user_mapping where community_user_mapping_id ='".$insert_id."'"; $res = $this->db->query($sql);
            $row = $res->row();
            $community_id = $row->community_id;
   ...
   function user_comment_alertwise(){
      ...
      'status' => 1);
       ...
       if($data){
          $returnresult = array('status' => 1, 'message' => 'User comment successfully submit');
            }else
            {          
             $returnresult = array('status' => 0, 'error' => 'Some data not valid' );
           }
 ...
 function user_comment_communitywise(){
   ...
   function get_comment_communitywise() {
        $this->db->select('tbl_user.*,tbl_user.user_id,tbl_community_user_mapping.user_id,tbl_community_user_mapping.status, tbl_comment.*');
        $this->db->from('tbl_community_user_mapping');
        $this->db->join('tbl_user', 'tbl_user.user_id = tbl_community_user_mapping.user_id', 'INNER');
  ...
  function notification_setting(){
    ...
    $res = $this->db->query($check);
      ...
      $data = array(
         ...
         if($data){
         $returnresult = array('status' => 1, 'message' => 'User notification setting update successfully' ); 
       }               
 }
else{
      $data = array(
      ...
      'status' => 1);
       ...
       if($data){
          $returnresult = array('status' => 1, 'message' => 'User notification setting successfully submit');
            }else
            {          
             $returnresult = array('status' => 0, 'error' => 'Some data not valid' );
           }
 ...
 $check="SELECT * FROM  tbl_user WHERE user_id ='".$_REQUEST['user_id']."'";
    $res = $this->db->query($check);
        if($res->num_rows > 0) 
         ...
         if($data){
          $returnresult = array('status' => 1, 'message' => 'User history update successfully');
            }else
            {          
             $returnresult = array('status' => 0, 'error' => 'Some data not valid' );
           }
           ...
           //  $profile_pic = $path.$profile_pic;
               ...
               $data = array(
                 ...
                 'profile_pic' => $path.$profile_pic
                  ...
                  $data= $this->db->update('tbl_user', $data);
                 if($data){
                 $returnresult = array('status' => 1, 'message' => 'User profile update successfully');
                }
              }
         else
            {          
...
function update_home_address(){
    ...
    $res = $this->db->query($check);
      ...
      $data = array(
         ...
         if($data){
         $returnresult = array('status' => 0, 'message' => 'User address update successfully' ); 
       }               
 }
else{
      $data = array(
      ...
      'status' => 1);
       ...
       if($data){
          $returnresult = array('status' => 1, 'message' => 'User address successfully submit');
            }else
            {          
             $returnresult = array('status' => 0, 'error' => 'Some data not valid' );
           }
...
$check="SELECT * FROM  tbl_emergency_contact WHERE emergency_contact_id ='".$_REQUEST['emergency_contact_id']."'";
    $res = $this->db->query($check);
     ...
     $data = array(
       ...
       if($data){
          $returnresult = array('status' => 1, 'message' => 'User contact  update successfully');
            }else
            {          
             $returnresult = array('status' => 0, 'error' => 'Some data not valid' );
           }
...
$check="SELECT * FROM  tbl_emergency_tracking WHERE user_id ='".$_REQUEST['user_id']."'";
    $res = $this->db->query($check);
      ...
      $data = array(
         ...
         if($data){
         $returnresult = array('status' => 0, 'message' => 'User emergency tracking update successfully' ); 
       }               
 }
else{
     $data = array(
       ...
       if($data){
          $returnresult = array('status' => 1, 'message' => 'User emergency tracking successfully submit');
            }else
            {          
             $returnresult = array('status' => 0, 'error' => 'Some data not valid' );
           }
    ...
    function get_emergency_tracking() {
     ...
     {               
      ...
      if($data){
          $returnresult = array('status' => 1, 'message' => 'User delete successfully');
            }else
            {          
             $returnresult = array('status' => 0, 'error' => 'Some data not valid' );
           }
     ...
     {               
      ...
      if($data){
          $returnresult = array('status' => 1, 'message' => 'User emergency contact delete successfully');
            }else
            {          
             $returnresult = array('status' => 0, 'error' => 'Some data not valid' );
           }
